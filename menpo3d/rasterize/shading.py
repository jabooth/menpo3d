...
from menpo3d.result import as_colouredtrimesh
...
def lambertian_shading(mesh, diffuse_colour=(.5, .5, .5),
    ...
    # diffusion colour.
    lambertian = lambertian.sum(0) * diffuse_colour

    mesh.colours[...] = np.clip(mesh.colours + lambertian, 0, 1)
